...
namespace LunaTV.Controls;

//https://github.com/amwx/FluentAvalonia/blob/v1.3.5/FluentAvaloniaSamples/Controls/OptionsDisplayItem.cs
public class OptionsDisplayItem : TemplatedControl
{
    ...
    {
        if (Clickable && e.GetCurrentPoint(this).Properties.PointerUpdateKind == PointerUpdateKind.LeftButtonPressed)
        {
            _isPressed = true;
